<%-- Document: addNewTest || Date : Jan 12, 2018, 5:25:28 PM || @author : SKR --%>
   ...
   <div class="card ">
      ...
      <div class="card-body">
         <form name='formAddNewQuizAdmin' method="post" action='<c:url value="/AddNewQuiz"/>' class="m-0 p-0">
            <input type='hidden' name='attempts' value='1' readonly='true' class='form-control'>

            <div class='row'>

               <div class='col-md-12 col-sm-12 mb-3'>
                  <label class='m-0 text-muted mb-1'>Quiz Title</label>
                  <input type='text' name='quizTitle' class='form-control' autofocus="true">
               </div>
   ...
   <div class='card'>
      <div class='card-body'>
         ...
         <p class='m-0 p-0'>
            ...
            <br>
            <br>
            You may add/edit/delete question(s) in "Edit quiz section"
            <br>
         <p class='text-right m-0 p-0 mt-2'>${suchi}</p>
      </div>
   </div>
</div>
